          ...
          <div class="box-header with-border">
            <form role="form" method="post">
                ...
                <div class="box">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <select type="text" class="form-control" id="agregarCliente" name="agregarCliente" required>
                        <option value="">Seleccionar cliente</option>
                      </select>
                      <span class="input-group-addon"><button class="btn btn-default btn-xs" type="button" data-toggle="modal" 
                  ...
                  <div class="form-group row nuevoProducto">
                    <div class="col-xs-6" style="padding-right:0px">
                      <div class="input-group">
                        <span class="input-group-addon"><button class="btn btn-danger btn-xs"type="button"><i class="fa fa-times"></i></button></span>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td style="width: 50%">
                              <div class="input-group">
                                <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
                                <input type="number" class="form-control" min="1" id="nuevoTotalVenta" name="nuevoTotalVenta" placeholder="00000" required readonly>
                  ...
                  <div class="form-group row">
                    <div class="col-xs-6" style="padding-right:0px">
                      <div class="input-group">
                        <select name="nuevoMetodoPago" id="nuevoMetodoPago" class="form-control">
              ...
              <div class="box-footer">
                <button class="btn btn-primary pull-right">Guardar venta</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <div class="modal-content">
      <form role="form" method="post">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Guardar ccliente</button>
        </div>
